...
(function() {
  ...
  DB = (function() {
    ...
    DB.prototype._hkey_to_dirs = function(hkey) {
      var i, out, _i, _ref1;
      out = [];
      for (i = _i = 0, _ref1 = this.levels; 0 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 0 <= _ref1 ? ++_i : --_i) {
    ...
    DB.prototype.put = function(_arg, cb) {
      var dirs, encoding, err, esc, f, file, json, key, opts, typ, value, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    DB.prototype.get = function(_arg, cb) {
      var buf, err, f, json, key, value, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      key = _arg.key, json = _arg.json;
      value = null;
      err = null;
      f = this._mkpath_from_key(key);
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
    ...
    DB.prototype.del = function(_arg, cb) {
      var err, f, key, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      key = _arg.key;
      f = this._mkpath_from_key(key);
